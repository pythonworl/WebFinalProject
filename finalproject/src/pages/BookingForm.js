      ...
      <form onSubmit={handleSubmit} className="row justify-content-center">
        ...
        <div className="col-md-4 mb-3">
          ...
          <input
            ...
            name="email"
            id="email"
            placeholder="nelsonjoy8@yahoo.com"
            className="form-control"
            value={name.email}
            onChange={handleName}
            required={true}
        ...
        <button type="submit" className="col-md-6 btn btn-primary my-4" style={{ maxWidth: "400px" , backgroundColor: "rgba(0, 0, 0, 0.4)" , color: "white"}} disabled={!isGood()}>
          Confirm Reservation
        </button>
      </form>
    </section>
