      ...
      <div className="container">
        ...
        <div className="collapse navbar-collapse" id="navbarNavAltMarkup">
          <div className="navbar-nav mx-auto">
            ...
            <NavLink className={({ isActive }) => (isActive ? style.navActive : style.navNonActive)} to="/login">
              LOGIN
            </NavLink>
            <NavLink className={({ isActive }) => (isActive ? style.navActive : style.navNonActive)} to="/giftcards">
              GIFTCARDS
            </NavLink>
          </div>
        </div>
